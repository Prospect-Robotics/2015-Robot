...
import org.usfirst.frc.team2813.commands.ArcadeDrive;
...
import org.usfirst.frc.team2813.commands.PickupFullStack;
import org.usfirst.frc.team2813.commands.PickupTote;
...
import org.usfirst.frc.team2813.commands.ZeroDrive;
...
public class OI {
	...
	public OI() {
		...
		new JoystickButton(driver1, 11).whenPressed(new ElevatorHome());
		...
		new JoystickButton(operator, 10).whenPressed(new PickupTote());
		new JoystickButton(operator, 11).whenPressed(new PickupFullStack());
