...
import org.usfirst.frc.team2813.auto.TrashcanAuto;
import org.usfirst.frc.team2813.subsystems.Carriage;
import org.usfirst.frc.team2813.subsystems.Elevator;
import org.usfirst.frc.team2813.subsystems.IntakePivotIntegrated;
import org.usfirst.frc.team2813.subsystems.IntakePivotLeft;
import org.usfirst.frc.team2813.subsystems.IntakePivotRight;
import org.usfirst.frc.team2813.subsystems.IntakeRollers;
import org.usfirst.frc.team2813.subsystems.Nav6;
import org.usfirst.frc.team2813.subsystems.PIDDrive;
import org.usfirst.frc.team2813.subsystems.TrashcanGrabber;
...
public class Robot extends IterativeRobot {
	...
	public static Object trahcanGrabber;
	...
	public void robotInit() {
		...
		System.out.println("Intake1");
		intakePivotLeft = new IntakePivotLeft();
		System.out.println("Intake2");
		...
		pIDDrive.setsafety(false);
		autonomousCommand = new TrashcanAuto();
	...
	public void disabledPeriodic() {
		...
		if (oi.getdriver1().getRawButton(1))
			nav6.resetNav6(); // if button 1 is pressed on joystick the nav6
								// resets heading
		nav6.displayNav6Data(true); // Display Nav6 data on SmartDashboard or
									// not
	...
	public void teleopPeriodic() {
		SmartDashboard.putNumber("Stack", stack);
		nav6.displayNav6Data(true);
		Scheduler.getInstance().run();
		SmartDashboard.putNumber("Encoder", Robot.elevator.getEncoderValue());
		if (Robot.oi.getdriver1().getRawButton(10)) {
			// Will only reset if it is not calibrating
			Robot.nav6.resetNav6();
		}
		//if (Robot.elevator.getEncoderValue() <= 2453){
			//Robot.intakePivotIntegrated.intakePivotSet(0.121, 0.306); //left, right
		//}
	}
