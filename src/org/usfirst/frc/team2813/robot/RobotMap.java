...
public class RobotMap {
	...
	public static void init() {
		...
		LiveWindow.addActuator("Elevator", "elevatorRight",
				(Talon) elevatorelevatorRight);

		elevatorelevatorEncoder = new Encoder(0, 1, false, EncodingType.k4X);
		LiveWindow.addSensor("Elevator", "elevatorEncoder",
		...
		LiveWindow.addActuator("IntakePivot", "intakePivotLeft",
				(Victor) intakePivotintakePivotLeft);

		intakePivotintakePivotRight = new Victor(3);
		LiveWindow.addActuator("IntakePivot", "intakePivotRight",
				(Victor) intakePivotintakePivotRight);

		intakePivotintakePotLeft = new AnalogPotentiometer(0, 1.0, 0.0);
		LiveWindow.addSensor("IntakePivot", "intakePotLeft",
				intakePivotintakePotLeft);

		intakePivotintakePotRight = new AnalogPotentiometer(1, 1.0, 0.0);
		LiveWindow.addSensor("IntakePivot", "intakePotRight",
				intakePivotintakePotRight);

		carriagecarriageSolenoid = new DoubleSolenoid(0, 0, 1);
		LiveWindow.addActuator("Carriage", "carriageSolenoid",
				carriagecarriageSolenoid);

		intakeRollersintakeRollerLeft = new Victor(8);
		LiveWindow.addActuator("IntakeRollers", "intakeRollerLeft",
				(Victor) intakeRollersintakeRollerLeft);
