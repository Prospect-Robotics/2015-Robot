...
public class PIDDrive extends PIDSubsystem {
	...
	public PIDDrive() {
		...
		LiveWindow.addActuator("RobotDrive", "PIDSubsystem Controller",
				getPIDController());
	...
	public void mecanumCartesian(double x, double y, double rotation,
			double gyroAngle) {
	...
	public void setsafety(boolean mode) {
		drive.setSafetyEnabled(mode);
	}
}
